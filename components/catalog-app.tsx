      ...
      <div className="mx-auto max-w-7xl px-4 py-8 md:px-6 lg:px-8">
        <div className="mb-8 flex items-center justify-between border-b border-slate-800 pb-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-semibold tracking-[0.18em] text-slate-200">KBCOMPARE</div>
              <div className="text-xs text-slate-500">Keyboard database and side-by-side comparison tool</div>
            </div>
          </div>
        ...
        <div className="mb-8 grid gap-6 lg:grid-cols-[340px_1fr]">
          ...
          <div className="space-y-6">
            <Card className="border-slate-800 bg-slate-900/60">
              <CardHeader>
                <CardTitle className="text-2xl text-white">Compare selected keyboards</CardTitle>
                <CardDescription className="text-slate-400">Only the keyboards you selected appear here, with normalized image panels and deeper specs.</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            {selected.length > 0 && specGroups.map((group) => (
